...
public class FPSCam : MonoBehaviour
{
    ...
    void xuanzhuanScene()
    {
        if (Input.GetMouseButton(1))
        {
            ...
            if (_cam.transform.eulerAngles.x > 50 && _cam.transform.eulerAngles.x < 180)
            {
                _cam.transform.eulerAngles = new Vector3(50, _cam.transform.eulerAngles.y, _cam.transform.eulerAngles.z);
            }
